                ...
                <form onSubmit={handleBooking} className='p-6 space-y-5'>
                    ...
                    <div className='pt-2'>
                        <button 
                            type="submit" 
                            disabled={loading} 
                            className='w-full bg-blue-600 text-white rounded-xl py-4 font-bold text-lg shadow-lg shadow-blue-200 hover:bg-blue-700 hover:shadow-xl transition disabled:opacity-70 disabled:hover:shadow-none'
                        >
